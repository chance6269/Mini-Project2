...
# 각 값을 소수점 이하 두 자리로 변환
explained_variance_rounded = [float(f"{var:.5f}") for var in explained_variance]

print(f"Explained variance by each component: {explained_variance_rounded}")
