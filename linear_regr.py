...
plt.rc("xtick", labelfont=("NanumBarunGothic", 14))
plt.rc("ytick", labelfont=("NanumBarunGothic", 14))
# %%
...
# 개별 Fold MSE: [0.0087 0.0143 0.0198 0.009  0.0077]
# 평균 MSE:0.0119